<header class="header">
    <div class="header__contenedor">
        ...
        <div class="header__contenido">
            ...
            <p class="header__texto">Julio 13-14 - 2024</p>
...
<div class="barra">
    <div class="barra__contenido">
        ...
        <nav class="navegacion">
            <a href="/openwebcongress" class="navegacion__enlace <?php echo pagina_actual('/openwebcongress') ? 'navegacion__enlace--actual' : ''; ?>">Evento</a>
