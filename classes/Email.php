...
class Email {
    ...
    public function enviarConfirmacion() {
         ...
         $mail->setFrom('cuentas@openwebcongress.com');
         ...
         $contenido = '<html>';
         $contenido .= "<p><strong>Hola " . $this->nombre .  "</strong> Has Registrado Correctamente tu cuenta en OpenWebCongress; pero es necesario confirmarla</p>";
